<?php
    ...
    session_start();
    if($_SESSION['login']['jenis_id'] == "marketing"){
?>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active">
                            <a href="marketing.php">
                                <i class="fas fa-envelope-open"></i>Marketing</a>
                        </li>
                        <li>
                            <a href="logout.php">
                                                    ...
                                                    <table class="table table-borderless table-striped table-earning table-khusus" style="width:100% !important">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="marketing-print?id=<?php echo $data['id_pengajuan']; ?>" class="button-pemilik-ya">PRINT</a></td>
                                                            </tr>
                                                            <?php
                                                                    $no++;
                                                                }
...
<?php
        ...
        echo "
            <script>
                alert ('Anda harus login sebagai Bagian Marketing');
                location = 'login.html';
            </script>
        ";
    }
